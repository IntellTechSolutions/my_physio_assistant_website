          ...
          <div className="border-l-4 border-teal-500 pl-6 py-2 bg-sky-50/50 rounded-r-lg">
            ...
            <div className="space-y-4">
              <div>
                ...
                <p className="text-base">
                  The content generated by the Service is based on documents sourced from Intelligent Technology Solutions Limited (proprietary clinical content), NHS patient leaflets, and open-access research.
                </p>
              </div>
